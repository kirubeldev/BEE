   ...
   <section className="cta-three">
      <div className="auto-container">
        ...
        >
          <div
            ...
            style={{
              backgroundImage: "url(./assets/images/background/cta-three_pattern.png)"
            }}
          />
          <div
            className="cta-three_pattern-two"
            style={{
              backgroundImage: "url(./assets/images/background/cta-three_pattern-1.png)"
            }}
          />
    ...
    <footer className="main-footer">
      <div
        ...
        style={{ backgroundImage: "url(./assets/images/background/footer-pattern-1.png)" }}
      />
      <div
        className=""
        style={{ backgroundImage: "url(./assets/images/background/footer-pattern-2.png)" }}
      />
      <div className="auto-container">
                  ...
                  <div className="footer_column col-lg-7 col-md-6 col-sm-12">
                    <div className="footer-widget footer-two_logo-widget">
                      <div className="footer-logo">
                        <a href="index-2.html">
                          <img src={logo} alt="" title="" style={{width:"140px"}}/>
                        </a>
                      </div>
                      <div className="footer-text">
                      Aiming to improve Africa by breaking from the conventional global narrative, BEE seeks to establish a global network of African voices to expand economic potential. 
                      </div>
                    </div>
                  </div>
                  {/* Footer Column */}
                    ...
                    <div className="footer-widget post-widget">
                      ...
                      <div className="news-widget-block">
                        <div className="news-widget_image">
                          <img src="./assets/images/resource/post-thumb-4.jpg" alt="" />
                        </div>
                      ...
                      <div className="news-widget-block">
                        <div className="news-widget_image">
                          <img src="./assets/images/resource/post-thumb-5.jpg" alt="" />
                        </div>
                        <h6 className="news-widget_title">
                          <a href="news-detail.html">
  ...
  <div className="color-palate">
    ...
    <div className="color-palate-inner">
      ...
      <div className="purchase-box">
        ...
        This color picker is used only for demonstation purposes.

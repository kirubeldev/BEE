      ...
      <ul className="nav nav-minimal appbar-nav" id="appNavTab" role="tablist">
        <li className="nav-item" role="presentation">
          <a
            ...
            aria-selected="true"
          >
            {/* <img class="injectable hw-22" src="./../../assetss/assetss/media/heroicons/outline/translate.svg" alt=""> */}
            <svg
        ...
        <li className="nav-item" role="presentation">
          <a
            ...
            aria-selected="false"
          >
            {/* <img class="injectable hw-22" src="./../../assetss/assetss/media/heroicons/outline/collection.svg" alt=""> */}
            <svg
              xmlns="http://www.w3.org/2000/svg"
              height={24}
              width={24}
        ...
        <li className="nav-item" role="presentation">
          <a
            ...
            aria-selected="false"
          >
            {/* <img class="injectable hw-22" src="./../../assetss/assetss/media/heroicons/outline/clipboard-check.svg" alt=""> */}
            <svg
              xmlns="http://www.w3.org/2000/svg"
              height={24}
              width={24}
        ...
        <li className="nav-item" role="presentation">
          <a
            ...
            aria-selected="false"
          >
            {/* <img class="injectable hw-22" src="./../../assetss/assetss/media/heroicons/outline/cog.svg" alt=""> */}
            <svg
              xmlns="http://www.w3.org/2000/svg"
              height={24}
              width={24}
                ...
                <div className="card">
                  <div className="card-body">
                    <p className="mb-0">
                      ...
                      incipere velis. Spes autem quae erant incipiens cum risu!
                    </p>
                  </div>
                </div>
              </div>
                ...
                <li className="list-group-item">
                  <div className="media">
                    <div className="btn btn-primary btn-icon rounded-circle text-light mr-2">
                      ...
                      {/* Alternate :: External File link */}
                      {/* <img class="injectable hw-24" src="./../../assetss/assetss/media/heroicons/outline/user-add.svg" alt=""> */}
                    </div>
                    <div className="media-body">
                      <h6>
                ...
                <li className="list-group-item">
                  <div className="media">
                    <div className="btn btn-primary btn-icon rounded-circle text-light mr-2">
                      ...
                      {/* Alternate :: External File link */}
                      {/* <img class="injectable hw-24" src="./../../assetss/assetss/media/heroicons/outline/check-circle.svg" alt=""> */}
                    </div>
                    <div className="media-body">
                      <h6>
                ...
                <li className="list-group-item">
                  <div className="media">
                    <div className="btn btn-primary btn-icon rounded-circle text-light mr-2">
                      ...
                      {/* Alternate :: External File link */}
                      {/* <img class="injectable hw-24" src="./../../assetss/assetss/media/heroicons/outline/photograph.svg" alt=""> */}
                    </div>
                    <div className="media-body">
                      <h6>
          ...
          <form>
            <div className="form-group">
              ...
              <input
                ...
                className="form-control"
                id="editTaskName"
                defaultValue="Dinner with friends"
